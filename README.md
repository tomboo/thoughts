...
**Design phase.** Architecture lives under [docs/design/](./docs/design/). Implementation plans live under [docs/plans/](./docs/plans/). Reviews live under [docs/reviews/](./docs/reviews/). Operational runbooks and handoff notes live under [docs/ops/](./docs/ops/). ADRs live under [docs/adr/](./docs/adr/). Project tasks live under [tasks/](./tasks/) and can be viewed through [bases/tasks.base](./bases/tasks.base).
