...
This directory contains implementation plans, test plans, and milestone plans that are more detailed than architecture sketches but not themselves durable architecture decisions.
